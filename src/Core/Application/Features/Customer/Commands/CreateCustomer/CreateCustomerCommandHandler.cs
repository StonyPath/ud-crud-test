...
public class CreateCustomerCommandHandler : IRequestHandler<CreateCustomerCommand, CustomerId>
{
    ...
    public async Task<CustomerId> Handle(CreateCustomerCommand request, CancellationToken cancellationToken)
    {
        ...
        var customer = Domain.Aggregates.Customer.Entities.Customer.Create(firstName, 
                                                                           lastName,
                                                                           dateOfBirth,
                                                                           phoneNumber,
                                                                           email,
